...
public class Hacker : MonoBehaviour
{
    ...
    string[] level3Passwords = { "shit", "bit", "hand", "bad", "golf"};
    ...
    */
    ...
    void OnUserInput(string input)
    {
        ...
        {
            Terminal.WriteLine("If on the web, close the app")
            Application.Quit(); // only quits on the PC
        }
    ...
    void AskForPassword()
    {
        ...
        Terminal.ClearScreen();
        SetRandomPassword();
        Terminal.WriteLine("Enter your password: " + password.Anagram());   //Angram is a method provided by the Udemy guys
        Terminal.WriteLine(menuHint);
    }
...
\--/             
                ...
                break;
            case 3:
                Terminal.WriteLine("Have a ball for level 3");
                Terminal.WriteLine(@"
\  /          
 \/               
 /\               
